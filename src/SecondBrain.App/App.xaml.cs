...
public partial class App : Application
{
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        try
        {
            ...
            if (smokePhase is not null and not "seed" and not "verify" and not "voice" and not "deepgram" and not "flow" and not "timed" and not "study" and not "replay" and not "stream" and not "audio" and not "transcription" and not "companion" and not "companion-live" and not "knowledge" and not "knowledge-live" and not "history" and not "history-live" and not "storage" and not "wrap" and not "tray" and not "shell" and not "chrome" and not "shortcuts" and not "context" and not "latency" and not "opening" and not "flowing" and not "flowing-live" and not "rich" and not "speakers" and not "assistant" and not "assistant-live" and not "hybrid" and not "transcription-live" and not "performance" and not "performance30") throw new ArgumentException("Unknown smoke phase.");
