...
public partial class AssistantWindow : Window
{
    ...
    private AssistantOptions Options() => new(FastModel.Text.Trim(), DeepModel.Text.Trim(), FastEffort.SelectedItem as string ?? "none", DeepEffort.SelectedItem as string ?? "medium", Deeper.IsChecked == true, ContextNotes.Text);
