param([string]$Executable = '',
    [ValidateSet('seed','verify','voice','flow','timed','study','replay','audio','transcription','hybrid','assistant','knowledge','history','storage','wrap','companion','stream','tray','shell','chrome','shortcuts','context','latency','opening','flowing','rich','speakers','capture','names','meet','imports','pdf','word','powerpoint','clientknowledge','suggestions','requests','memory','scoped')]
...
try {
    ...
    foreach ($phase in $Phases) {
        $phaseData = if ($phase -in @('voice','flow','timed','study','replay','stream','audio','transcription','hybrid','assistant','knowledge','history','storage','wrap','companion','tray','shell','chrome','shortcuts','context','latency','opening','flowing','rich','speakers','capture','names','meet','imports','pdf','word','powerpoint','clientknowledge','suggestions','requests','memory','scoped')) { Join-Path $data $phase } else { $data }
